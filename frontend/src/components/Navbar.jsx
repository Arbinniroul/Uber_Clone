...
const Navbar = ({handlePopUp}) => {
  ...
  return (
    <div className='relative flex justify-between items-center py-3 px-4 sm:py-4 sm:px-6 md:px-10 lg:px-12 bg-black text-white'>
        ...
        <h1 className='text-2xl tracking-tight uber'>Logo</h1>
           ...
           <div className='flex items-center gap-3 lg:gap-1'>
            <div className='md:hidden hidden lg:flex sm:hidden gap-2 px-4 py-1 items-center  justify-center bg-white rounded-full text-black'>
            ...
            <div className='flex gap-3 text-sm font-medium items-center'>
              <button className=' cursor-pointer hidden md:hidden lg:flex  px-3 py-2 rounded-full bg-black hover:bg-gray-800 transition-all transform duration-500 ease-in-out '>Help</button>
